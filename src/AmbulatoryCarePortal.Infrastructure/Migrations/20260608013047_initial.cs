        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChecklistTemplates_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HrStaffs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HrStaffs_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HrStaffs_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvidenceRequired = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    EscalationRule = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FormVersions_AspNetUsers_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetObjectType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PolicyDocuments_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PolicyDocuments_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PolicyDocuments_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionTextAr = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChecklistRounds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChecklistRounds_AspNetUsers_ApprovedByUserId",
                        column: x => x.ApprovedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChecklistRounds_AspNetUsers_ExecutedByUserId",
                        column: x => x.ExecutedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChecklistRounds_ChecklistTemplates_ChecklistTemplateId",
                        column: x => x.ChecklistTemplateId,
                        principalTable: "ChecklistTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChecklistRounds_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChecklistRounds_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentNameAr = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HrDocuments_HrStaffs_HrStaffId",
                        column: x => x.HrStaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualValue = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyDocumentId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuditTrails_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuditTrails_PolicyDocuments_PolicyDocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EvidenceAttachments_AspNetUsers_UploadedByUserId",
                        column: x => x.UploadedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EvidenceAttachments_PolicyDocuments_PolicyDocumentId",
                        column: x => x.PolicyDocumentId,
                        principalTable: "PolicyDocuments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChecklistRoundId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChecklistAnswers_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChecklistAnswers_ChecklistItems_ChecklistItemId",
                        column: x => x.ChecklistItemId,
                        principalTable: "ChecklistItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChecklistAnswers_ChecklistRounds_ChecklistRoundId",
                        column: x => x.ChecklistRoundId,
                        principalTable: "ChecklistRounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditTrails_ClinicId_ActionDate",
                table: "AuditTrails",
                columns: new[] { "ClinicId", "ActionDate" },
                descending: new[] { false, true });

            migrationBuilder.CreateIndex(
                name: "IX_AuditTrails_PolicyDocumentId",
                table: "AuditTrails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChecklistAnswers_ChecklistItemId",
                table: "ChecklistAnswers",
                column: "ChecklistItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistAnswers_ChecklistRoundId",
                table: "ChecklistAnswers",
                column: "ChecklistRoundId");

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistAnswers_OwnerId",
                table: "ChecklistAnswers",
                column: "OwnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChecklistRounds_ApprovedByUserId",
                table: "ChecklistRounds",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistRounds_ChecklistTemplateId",
                table: "ChecklistRounds",
                column: "ChecklistTemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChecklistRounds_DepartmentId",
                table: "ChecklistRounds",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistRounds_ExecutedByUserId",
                table: "ChecklistRounds",
                column: "ExecutedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistTemplates_ClinicId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvidenceAttachments_PolicyDocumentId",
                table: "EvidenceAttachments",
                column: "PolicyDocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_EvidenceAttachments_UploadedByUserId",
                table: "EvidenceAttachments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormVersions_UploadedByUserId",
                table: "FormVersions",
                column: "UploadedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HrStaffs_ClinicId",
                table: "HrStaffs",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_HrStaffs_DepartmentId",
                table: "HrStaffs",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_KPIEntries_KPIId_PeriodYear_PeriodMonth",
                table: "KPIEntries",
                columns: new[] { "KPIId", "PeriodYear", "PeriodMonth" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_KPIs_ClinicId",
                table: "KPIs",
                column: "ClinicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PolicyDocuments_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PolicyDocuments_DepartmentId",
                table: "PolicyDocuments",
                column: "DepartmentId");
        }
